    ...
    <span
      ...
      :class="[
        ...
        orientation === 'horizontal'
          ...
          : 'before:top-1/2 before:right-0 before:left-0 before:mt-[-1.5px]',
        orientation === 'horizontal' ? 'before:h-full before:w-0.75' : 'before:h-0.75 before:w-full',
        // After
        'after:block',
        'after:absolute',
        orientation === 'horizontal'
          ? 'after:top-0 after:bottom-0 after:left-1/2 after:-ml-0.75'
          : 'after:top-1/2 after:right-0 after:left-0 after:-mt-0.75',
        orientation === 'horizontal' ? 'after:h-full after:w-1.5' : 'after:h-1.5 after:w-full',
      ]"
      :style="{
